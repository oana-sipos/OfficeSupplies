...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { amount: @order_line.amount, article_id: @order_line.article_id, order_id: @order_line.order_id, order_line_id: @order_line.order_line_id }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { amount: @order_line.amount, article_id: @order_line.article_id, order_id: @order_line.order_id, order_line_id: @order_line.order_line_id }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
