class OrderLinesController < ApplicationController
  before_action :set_order_line, only: [:show, :edit, :update, :destroy, :more]
  ...
  def create
    ...
    respond_to do |format|
      if @order_line.save
        format.html { redirect_to order_path(id: order_line_params[:order_id]), notice: 'Order line was successfully created.' }
  ...
  private
    ...
    def order_line_params
      params.require(:order_line).permit(:order_line_id, :order_id, :article_id, :amount)
    end
end
